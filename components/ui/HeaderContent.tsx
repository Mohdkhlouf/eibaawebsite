...
export const HeaderContent = ({ socialLinks }: { socialLinks: SocialLink[] }) => {
  ...
  return (
    <section className="flex flex-col  bg-[linear-gradient(to_right,rgba(61,51,80,0.85),rgba(124,107,138,0.5)),url(/background.png)] bg-cover bg-center bg-no-repeat min-h-125">
